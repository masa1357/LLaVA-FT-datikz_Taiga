...
MODEL_PATH="llava-hf/llava-1.5-7b-hf"    #"llava-hf/llava-1.5-7b-hf"  #"./output/llava-datikz-lora/llava-datikz-full"
#OUTPUT_PATH="./results/eval_%j_${datetime}.json"
OUTPUT_PATH="./results/AF_testdata.json"
